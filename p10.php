...
?></a></li>
	...
	<li><a href="testsub.php">Skip question</a></li>
      </ul>
    </div>
<div class="container" >
...
$tid=$_SESSION['tid'];
$result=mysqli_query($conn,"SELECT Q10 FROM counters where T_id='$tid'");
if($row = mysqli_fetch_assoc($result))
{
if($row["Q10"]<=5)
{
echo "<br><br>
      <p><strong><div class='panel-heading'><h5><center>current count ".$row["Q10"]."</center></h5></strong><p>";

$result=mysqli_query($conn,"UPDATE counters SET Q10=Q10+1 WHERE T_id=$tid");
$x=strtoupper($x);
$l=strlen($x);
$as=' ';
for($i=0;$i<$l/2;$i++)
...
echo "<center><form action='a10.php' method='post'><div class='panel-body'><strong><h4>
How will breakthecode be encrypted?</h4></strong>
